...
class NavigationApiClient {
  ...
  async translate(amrIp, params) {
    return await this._sendNavigationCommand(amrIp, API_ENDPOINTS.NAVIGATION.TRANSLATE, params);
  }

  async turn(amrIp, params) {
    return await this._sendNavigationCommand(amrIp, API_ENDPOINTS.NAVIGATION.TURN, params);
  }

  async circular(amrIp, params) {
    return await this._sendNavigationCommand(amrIp, API_ENDPOINTS.NAVIGATION.CIRCULAR, params);
  }
